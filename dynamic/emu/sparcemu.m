...
| "ret" () => {
snprintf( buf, buflen, "                   ");
if( opname ) *opname = "ret";
}
| "retl" () => {
snprintf( buf, buflen, "                  ");
if( opname ) *opname = "retl";
}
| "JMPL" (address_, rd) => {
char tmp1[13];
disassembleaddress_( address_, tmp1, sizeof(tmp1), NULL );
...
sint32_t nextPC;
match [nextPC] pc to
| "inc" (op_simm13, op_rd) => executeINC( ((sint16_t)op_simm13), ((sint8_t)op_rd) );
...
| "inccc" (op_simm13, op_rd) => executeINCCC( ((sint16_t)op_simm13), ((sint8_t)op_rd) );
...
| "bclr" (op_regorimm, op_rd) => executeBCLR( decodereg_or_imm( op_regorimm ), ((sint8_t)op_rd) );
...
| "btst" (op_regorimm, op_rs1) => executeBTST( decodereg_or_imm( op_regorimm ), ((sint8_t)op_rs1) );
...
| "call_" (op_eaddr) => executeCALL_( decodeeaddr( op_eaddr ) );
| "jmp" (op_eaddr) => executeJMP( decodeeaddr( op_eaddr ) );
| "ret" () => executeRET(  );
| "retl" () => executeRETL(  );
...
| "NOP" () => executeNOP(  );
| "bset" (op_regorimm, op_rd) => executeBSET( decodereg_or_imm( op_regorimm ), ((sint8_t)op_rd) );
| "clr" (op_rd) => executeCLR( ((sint8_t)op_rd) );
| "mov" (op_regorimm, op_rd) => executeMOV( decodereg_or_imm( op_regorimm ), ((sint8_t)op_rd) );
| "mov_" (op_rs2, op_rd) => executeMOV_( ((sint8_t)op_rs2), ((sint8_t)op_rd) );
...
| "tst" (op_rs2) => executeTST( ((sint8_t)op_rs2) );
...
| "clr_" (op_eaddr) => executeCLR_( decodeeaddr( op_eaddr ) );
| "ST" (op_rd, op_eaddr) => executeST( ((sint8_t)op_rd), decodeeaddr( op_eaddr ) );
| "clrb" (op_eaddr) => executeCLRB( decodeeaddr( op_eaddr ) );
...
| "clrh" (op_eaddr) => executeCLRH( decodeeaddr( op_eaddr ) );
| "STH" (op_rd, op_eaddr) => executeSTH( ((sint8_t)op_rd), decodeeaddr( op_eaddr ) );
| "dec" (op_simm13, op_rd) => executeDEC( ((sint16_t)op_simm13), ((sint8_t)op_rd) );
| "neg" (op_rd) => executeNEG( ((sint8_t)op_rd) );
| "neg2" (op_rs2, op_rd) => executeNEG2( ((sint8_t)op_rs2), ((sint8_t)op_rd) );
...
| "cmp" (op_rs1, op_regorimm) => executeCMP( ((sint8_t)op_rs1), decodereg_or_imm( op_regorimm ) );
| "deccc" (op_simm13, op_rd) => executeDECCC( ((sint16_t)op_simm13), ((sint8_t)op_rd) );
...
| "not" (op_rd) => executeNOT( ((sint8_t)op_rd) );
| "not2" (op_rs1, op_rd) => executeNOT2( ((sint8_t)op_rs1), ((sint8_t)op_rd) );
...
| "btog" (op_regorimm, op_rd) => executeBTOG( decodereg_or_imm( op_regorimm ), ((sint8_t)op_rd) );
