    ...
    *************************************************************/    
    class RegComponents {
        ...
        private JPanel createRegWindowPanel() {
	    	...
	    	@IntegerRegisters COLUMN	    
                        
	    	@IntegerRegisters OBJARRAY_INSERTED	    

            regTable = new JTable(regModel);

	    	@IntegerRegisters COLUMNWIDTH	    
        ...
        private JPanel createProgramCounterPanel() {
	    	...
	    	@ProgramCounter COLUMN	    	    
	    	@ProgramCounter OBJARRAY
                                         
            regModelPC.addRow(objArray);
            regTablePC = new JTable(regModelPC);

	    	@ProgramCounter COLUMNWIDTH	    
        ...
        private JPanel createConditionCodePanel() {
	    	...
	    	@ConditionCode COLUMN                        
	    	@ConditionCode OBJARRAY

            regModelCC.addRow(objArray);
            regTableCC = new JTable(regModelCC);
	    	
			@ConditionCode COLUMNWIDTH	    
        ...
        public synchronized void modifyRegValue(RegFile inRegFile) {
			...
			@IntegerRegisters MODIFYVALUE	
	    	@ConditionCode MODIFYVALUE
	    	@ProgramCounter MODIFYVALUE
            // regModelFloat                        
        }       
    }        
